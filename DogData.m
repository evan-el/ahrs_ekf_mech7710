...
accel = [static.acc.X; static.acc.Y; static.acc.Z;]';
...
magCalGyro = [magCal.omega.X; magCal.omega.Y; magCal.omega.Z;]';

magCalVar = mean(var(magCalmag));
accCalVar = mean(var(magCalAcc));
...
gyro_int(:,1) = [deg2rad(0); deg2rad(0); deg2rad(0)]; %% changed here
